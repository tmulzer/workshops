 ...
 * Copyright (c) 2018 Tasso Mulzer, BHT
 *
 ...
 *
 * This example sends a valid LoRaWAN packet with payload of your name,
 * using frequency and encryption settings matching those of
 * the The Things Network.
 * DO NOT DO THIS, except if you want to show how NOT TO use payload bytes.
 *
...
// AB HIER FÜR JEDEN NODE NEU AUSFÜLLEN 
//***************************************
...
static const u4_t DEVADDR = 0x<DevAddr> ; // <-- Change this address for every node!
...
// Pin mapping
// Adapted for Dragino UNO
const lmic_pinmap lmic_pins = {
    .nss = 10,                      // chip select CS
    .rxtx = LMIC_UNUSED_PIN,        
    .rst = 9,                       // reset pin
    .dio = {2, 6, 7},               // SPI-data In/Out
};
